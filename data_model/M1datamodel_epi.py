...
class DMTBaseDataModule(pl.LightningDataModule):
    ...
    def load_data(self, data_path):
        data = np.load(os.path.join(data_path, "difftreedata/data/EpitheliaCell_data_n.npy"))
        label = np.load(os.path.join(data_path, "difftreedata/data/EpitheliaCell_label.npy"))
        ...
        print(f"Epithelia loaded: {data.shape}")
