...
int main() {
  ...
  double perplexity, early_exaggeration, theta, *data, *Y_init;
  int rand_seed = -1;
  ...
  if(DENSNE::load_data(&data, &origN, &D, &no_dims, &theta, &perplexity, &early_exaggeration, &rand_seed,
    ...
    DENSNE::run(data, N, D, Y, dens, no_dims, perplexity, early_exaggeration, theta, rand_seed, skip_rand_init,
