...
class DMTBaseDataModule(pl.LightningDataModule):
    ...
    def load_data(self, data_path, sample_data_size=60000):
        ...
        file_path = "/root/hanning/mulleveldr/m1data/Quinn_2021_Science_5k.h5ad"


        adata = sc.read(file_path)
        # import pdb; pdb.set_trace()

        sc.pp.filter_genes(adata, min_counts=1)      # 至少 1 个 counts
        sc.pp.filter_genes(adata, min_cells=3)       # 至少在 3 个细胞中出现过
        ...
        adata.obs['batch'] = adata.obs['sample_information']
    ...
    def sample_multi_level_data(self, data, label, sample_size_list = [2000, 60000]):
        ...
        for i, sample_size in enumerate(sample_size_list):
            ...
            # neighbors_index = self.adj_to_neighbors_index(adj)
            # import pdb; pdb.set_trace()
    ...
    def setup(self, stage: str):
        ...
        self.sampler = MultiClusterBatchSampler(
            neighbors_index=neighbors_list[-1],
