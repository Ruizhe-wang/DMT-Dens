...
class DMTBaseDataModule(pl.LightningDataModule):
    ...
    def load_data(self, data_path):
        ...
        adata.obs['final_annotation'] = np.asarray(label_col).astype(str)
        adata.obs['cell_type'] = np.asarray(label_col).astype(str)
        adata.obs['celltype'] = np.asarray(label_col).astype(str)
