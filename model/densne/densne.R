...
write_binary_file <- function(matrix, path.to.bin.file, theta, perplexity,
                              ...
                              final_dens, randseed, early_exaggeration) {
    ...
    writeBin(as.double(early_exaggeration), connection, size=8)
