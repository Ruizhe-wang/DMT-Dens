...
def anytree_to_networkx(root, n_neighbors=7, build_graph_knn_key="high_emb"):
...
class PlotTree(pl.Callback):
    ...
    def on_validation_epoch_end(self, trainer, pl_module, down_sample=20000):
        ...
        log_dict = {}
        fig_lineage = self.plot_single_lineage_with_label(
            root,
            lineage_start=lineage_start,
            lineage_end=lineage_end,
            data_vis=data_vis,
        )
        log_dict[f"lineage/lineage{self.vis_index}"] = fig_lineage
